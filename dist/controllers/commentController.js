...
const createComment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const comment = yield commentService.createComment(req.body);
...
const getCommentsByPostId = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const comments = yield commentService.getCommentsByPostId(Number(req.params.postId));
...
const deleteComment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield commentService.deleteComment(Number(req.params.commentId));
        res.status(204).send();
    }
    catch (error) {
